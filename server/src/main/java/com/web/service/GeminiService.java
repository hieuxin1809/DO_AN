    ...
    public String chatWithAI(String userMessage) {
        try {
            ...
            sysParts.put("text",
                ...
                "- Cần thăm khám trước: Người có tiền sử dị ứng vaccine, phụ nữ mang thai, người suy giảm miễn dịch, bệnh mãn tính.\n" +
                ...
                "- Nếu khách hỏi về giá vaccine cụ thể: Đề nghị xem trên website hoặc gọi hotline 0977.011.436.\n" +
